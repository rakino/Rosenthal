...
Substitutes (see [[https://guix.gnu.org/manual/devel/en/html_node/Substitutes.html][Substitutes]] in /GNU Guix Reference Manual/) are available on https://substitute.boiledscript.com, with the following signing key:
#+begin_src scheme
  (public-key
   (ecc
    (curve Ed25519)
