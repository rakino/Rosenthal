...
(define-public komga-bin
  (package
   ...
   (source (origin
             ...
             (sha256
              (base32
               "0li77wgxvwjq326k97i6lgzlqiaz69ardx7w2pw6500cvqg9nkiv"))))
...
(define-public wakatime-cli-bin
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0jrggjc62lywvsb1x8y659w4iypb8qxdgvalr2fq0agldvajjvnq"))))
    (build-system gnu-build-system)
    (arguments
     (list #:tests? (not (%current-target-system))
           #:imported-modules
...
(define-public loki-bin
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0dw16ls86n31nkp8g23hcx3h604al32fr3hlhm75n66ay4h9ch0w"))))
    (build-system copy-build-system)
    (arguments
     (list #:install-plan
